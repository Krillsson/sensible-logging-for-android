...
internal expect fun formatTimestamp(timestamp: Long): String

internal expect fun printToStandardError(message: String)

internal expect fun createMeta(stackDepth: Int): Meta
